      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              context,
              'Rating Ranges & Skill Levels',
              Icons.trending_up,
              [
                '🔰 Beginner: 800-1000 (Learning the basics)',
                '📈 Developing: 1000-1200 (Building skills)',
                '⚡ Intermediate: 1200-1400 (Solid performance)',
                '🎯 Advanced: 1400-1600 (Strong cognitive abilities)',
                '🏆 Expert: 1600-1800 (Exceptional performance)',
                '👑 Master: 1800+ (Elite cognitive performance)',
              ],
            ),
